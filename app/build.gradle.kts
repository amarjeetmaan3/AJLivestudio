...
dependencies {
    ...
    val composeBom =
        enforcedPlatform("androidx.compose:compose-bom:2024.06.00")
    ...
    implementation(
        "io.github.thibaultbee.streampack:streampack-core:$streamPackVersion"
    )

    implementation(
        "io.github.thibaultbee.streampack:streampack-ui:$streamPackVersion"
    )
